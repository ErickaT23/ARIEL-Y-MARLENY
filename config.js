...
const config = {
  ...
  seo: {
    ...
    autor: "Two Design",
    keywords: "invitacion, cumpleaños, aniversario, Ariel de León, Marleny Rodríguez, 60 años, 36 años de matrimonio, San Marcos",
  ...
  ceremonia: {
    ...
    padresNoviaTitulo: "60 años de vida",
    padresNovia: "Ariel de León y Marleny Rodríguez",
    padresNovioTitulo: "36 años de matrimonio",
    padresNovio: "Una vida compartida con amor y gratitud"
  },
  musica: {
  ...
  evento: {
    ...
    recepcion: {
      ...
      hora: "16:30 hrs",
      direccion: "10 avenida 9-62, San Marcos",
  ...
  itinerario: {
    titulo: "Itinerario",
    items: [
      { icono: "Images/ICONO-1.png", alt: "Misa", hora: "15:00 hrs", texto: "Misa de acción de gracias" },
      { icono: "Images/ICONO-3.png", alt: "Recepción", hora: "16:00 hrs", texto: "Recepción" }
    ]
  },
  dressCode: {
    titulo: "Dress Code",
  ...
  playlist: {
    titulo: "Playlist",
    descripcion: "Ayúdanos a crear la banda sonora de esta celebración. Agrega esas canciones que no pueden faltar en nuestra playlist.",
