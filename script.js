...
function renderInvitationContent() {
  ...
  setText("#playlistTitle", playlist.titulo || "Playlist");
  setText("#playlistText", playlist.descripcion || "");
  setText("#playlistLink", playlist.boton || "Agregar a Spotify");
  setLink("#playlistLink", playlist.url);
  setText("#giftTitle", regalo.titulo || "Regalo");
  setText("#giftText", regalo.descripcion || "");
  setText("#albumTitle", album.titulo || "Recuerdos para siempre");
  setText("#albumText", album.descripcion || "");
